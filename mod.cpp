dir = "@Tun Respawn System";
name = "Tun Respawn System v0.0.0";
...
tooltip		 = "Customizable wave-based respawn system";
tooltipOwned	= "Customizable wave-based respawn system";  // Tool tip displayed when the mouse is left over, in the main menu
overview		= "Tun Respawn System v0.0.0";		 // Overview text, displayed from the extension menu
