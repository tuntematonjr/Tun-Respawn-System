...
[_time, [_target, _setup], _code, {(localize "STR_tunres_MSP_DeployementAborted") call CBA_fnc_notify}, _text, _conditio, ["notOnMap","isnotinside"]] call ace_common_fnc_progressBar;